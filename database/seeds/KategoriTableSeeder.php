...
class KategoriTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('kategori')->insert(['kategori_adi'=>'Sınavlara Hazırlık', 'slug'=>'sinavlara-hazirlık', 'ust_id'=>$id]);
        ...
        DB::table('kategori')->insert(['kategori_adi'=>'Anne Çocuk', 'slug'=>'anne-cocuk']);
    }
}
